...
//
//    ResponseEntity<Void> response = testClients.visitorClient.postForEntity(
...
//    ResponseEntity<Void> deleteResponse = testClients.adminClient.exchange(
...
//
//    ResponseEntity<TestCustomer> getDeletedCustomerResponse = testClients.adminClient.getForEntity(
//      SCHEMA_HOST + port + CUSTOMER_PATH + "/" + customerId,
//      TestCustomer.class
//    );
...
//    List<ClientHttpRequestInterceptor> originalInterceptors = new ArrayList<>(testClients.adminClient.getRestTemplate().getInterceptors());
//
//    testClients.adminClient.getRestTemplate().getInterceptors().add((request, body, execution) -> {
...
//      testClients.adminClient.getRestTemplate().setInterceptors(originalInterceptors);
//    }
//  }
//
...
//    var customerClient = testClientFactory.createAuthenticatedClient(BASIC_USERNAME_VALUE, PASSWORD_VALUE);
//
...
//
//    // Löschen Sie den Kontakt
//    ResponseEntity<Void> deleteResponse = testClients.userClient.exchange(
//      SCHEMA_HOST + port + CUSTOMER_PATH + "/" + customerId + "/" + contactId,
//      HttpMethod.DELETE,
//      new HttpEntity<>(null, new HttpHeaders()),
//      Void.class
...
//
//    // Löschen Sie den Kontakt
//    ResponseEntity<Void> deleteResponse = testClients.supremeClient.exchange(
//      SCHEMA_HOST + port + CUSTOMER_PATH + "/" + customerId + "/" + contactId,
//      HttpMethod.DELETE,
//      new HttpEntity<>(null, new HttpHeaders()),
//      Void.class
...
//
//    // Löschen Sie den Kontakt
//    ResponseEntity<Void> deleteResponse = testClients.eliteClient.exchange(
//      SCHEMA_HOST + port + CUSTOMER_PATH + "/" + customerId + "/" + contactId,
//      HttpMethod.DELETE,
//      new HttpEntity<>(null, new HttpHeaders()),
//      Void.class
...
//
//    // Löschen Sie den Kontakt
//    ResponseEntity<Void> deleteResponse = testClients.basicClient.exchange(
//      SCHEMA_HOST + port + CUSTOMER_PATH + "/" + customerId + "/" + contactId,
//      HttpMethod.DELETE,
//      new HttpEntity<>(null, new HttpHeaders()),
//      Void.class
