package com.gentlecorp.account.dev;
...
import static com.gentlecorp.account.dev.DevConfig.DEV;
 ...
 * <p>
 * This controller is intended for use only in development profiles, as it includes methods that will
 * drop and recreate the database schema, which could result in data loss if used in a production environment.
 * </p>
 * <p>
 * The controller utilizes Flyway for database migration management, allowing it to clean the current
 * database state and re-apply all migrations from scratch.
 * </p>
 *
 * <h2>Usage</h2>
 * <p>
 * This controller should be triggered manually by a developer or via an automated process in a development
