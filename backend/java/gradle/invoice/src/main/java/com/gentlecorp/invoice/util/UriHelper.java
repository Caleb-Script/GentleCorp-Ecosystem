...
public class UriHelper {
  ...
  public URI getBaseUri(final HttpServletRequest request) {
    ...
    final var baseUri =
      STR."\{uriComponents.getScheme()}://\{uriComponents.getHost()}:\{uriComponents.getPort()}\{INVOICE_PATH}";
  ...
  private URI getBaseUriForwarded(final HttpServletRequest request, final String forwardedHost) {
    ...
    final var baseUri = STR."\{forwardedProto}://\{forwardedHost}\{forwardedPrefix}\{INVOICE_PATH}";
